...
const byte PWMB = 9; // PWM control (speed) for motor B
const byte DIRA = 2; // Direction control for motor A
const byte DIRB = 4; // Direction control for motor B
// LINKS -> A
// RECHTS -> A
//const byte PWMA = 2;  // PWM control (speed) for motor A
//const byte PWMB = 3; // PWM control (speed) for motor B
//const byte DIRA = 4; // Direction control for motor A
...
void loop()
{
  driveArdumoto(MOTOR_A, CW, 100); // Set motor A to CCW at max
  driveArdumoto(MOTOR_B, CW, 100); // Set motor A to CCW at max
